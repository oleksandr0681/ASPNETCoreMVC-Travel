...
public class AccountController : Controller
{
    ...
    public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
    {
        ...
        if (ModelState.IsValid)
        {
            int usersQuantity = _userManager.Users.Count();
            if (usersQuantity >= _maxUsersQuantity)
            {
                ModelState.AddModelError("", "Кількість користувачів перевищує " + _maxUsersQuantity + ".");
                return View(model);
            }
