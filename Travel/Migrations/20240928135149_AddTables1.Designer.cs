...
namespace Travel.Migrations
{
    ...
    [Migration("20240928135149_AddTables1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Travel.Models.Mark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Travel.Models.Mark", b =>
                {
                    b.HasOne("Travel.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Travel.Models.Place", null)
                        .WithMany("Marks")
